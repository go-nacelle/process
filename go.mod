...
require (
	...
	github.com/go-nacelle/config v0.0.0-20190604225719-35271539a545
	github.com/go-nacelle/log v0.0.0-00010101000000-000000000000
	github.com/go-nacelle/service v0.0.0-20190604231649-0bd05c3bbc75
