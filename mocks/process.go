...
// 2019-06-09T21:34:06-05:00
// using the command
// $ go-mockgen -f github.com/go-nacelle/process -i Process -o process.go
...
// MockProcess is a mock impelementation of the Process interface (from the
...
func (m *MockProcess) Init(v0 config.Config) error {
	...
	m.InitFunc.history = append(m.InitFunc.history, ProcessInitFuncCall{v0, r0})
	return r0
}
...
// Init method of the parent MockProcess instance inovkes the hook at the
...
func (m *MockProcess) Start() error {
	...
	m.StartFunc.history = append(m.StartFunc.history, ProcessStartFuncCall{r0})
	return r0
}
...
// PushHook adds a function to the end of hook queue. Each invocation of the
// Start method of the parent MockProcess instance inovkes the hook at the
// front of the queue and discards it. After the queue is empty, the default
// hook function is invoked for any future action.
...
func (m *MockProcess) Stop() error {
	...
	m.StopFunc.history = append(m.StopFunc.history, ProcessStopFuncCall{r0})
	return r0
}
...
// PushHook adds a function to the end of hook queue. Each invocation of the
// Stop method of the parent MockProcess instance inovkes the hook at the
// front of the queue and discards it. After the queue is empty, the default
// hook function is invoked for any future action.
