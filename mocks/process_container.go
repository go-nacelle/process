...
// MockProcessContainer is a mock impelementation of the ProcessContainer
...
func (m *MockProcessContainer) GetInitializers() []*process.InitializerMeta {
	...
	m.GetInitializersFunc.history = append(m.GetInitializersFunc.history, ProcessContainerGetInitializersFuncCall{r0})
	return r0
}
...
func (m *MockProcessContainer) GetProcessesAtPriorityIndex(v0 int) []*process.ProcessMeta {
	...
	m.GetProcessesAtPriorityIndexFunc.history = append(m.GetProcessesAtPriorityIndexFunc.history, ProcessContainerGetProcessesAtPriorityIndexFuncCall{v0, r0})
	return r0
}
...
func (m *MockProcessContainer) NumInitializers() int {
	...
	m.NumInitializersFunc.history = append(m.NumInitializersFunc.history, ProcessContainerNumInitializersFuncCall{r0})
	return r0
}
...
func (m *MockProcessContainer) NumPriorities() int {
	...
	m.NumPrioritiesFunc.history = append(m.NumPrioritiesFunc.history, ProcessContainerNumPrioritiesFuncCall{r0})
	return r0
}
...
// PushHook adds a function to the end of hook queue. Each invocation of the
// NumPriorities method of the parent MockProcessContainer instance inovkes
...
func (m *MockProcessContainer) NumProcesses() int {
	...
	m.NumProcessesFunc.history = append(m.NumProcessesFunc.history, ProcessContainerNumProcessesFuncCall{r0})
	return r0
}
...
// PushHook adds a function to the end of hook queue. Each invocation of the
// NumProcesses method of the parent MockProcessContainer instance inovkes
// the hook at the front of the queue and discards it. After the queue is
// empty, the default hook function is invoked for any future action.
...
func (m *MockProcessContainer) RegisterInitializer(v0 process.Initializer, v1 ...process.InitializerConfigFunc) {
	...
	m.RegisterInitializerFunc.history = append(m.RegisterInitializerFunc.history, ProcessContainerRegisterInitializerFuncCall{v0, v1})
	return
}
...
func (m *MockProcessContainer) RegisterProcess(v0 process.Process, v1 ...process.ProcessConfigFunc) {
	...
	m.RegisterProcessFunc.history = append(m.RegisterProcessFunc.history, ProcessContainerRegisterProcessFuncCall{v0, v1})
	return
}
