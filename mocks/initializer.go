...
// MockInitializer is a mock impelementation of the Initializer interface
...
func (m *MockInitializer) Init(v0 config.Config) error {
	...
	m.InitFunc.history = append(m.InitFunc.history, InitializerInitFuncCall{v0, r0})
	return r0
}
...
// Init method of the parent MockInitializer instance inovkes the hook at
