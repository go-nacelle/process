...
func TestProcessContainerInitializers(t *testing.T) {
	i1 := InitializerFunc(func(ctx context.Context, config config.Config) error { return fmt.Errorf("a") })
	i2 := InitializerFunc(func(ctx context.Context, config config.Config) error { return fmt.Errorf("b") })
	i3 := InitializerFunc(func(ctx context.Context, config config.Config) error { return fmt.Errorf("c") })
